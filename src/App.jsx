...
// styles
const styles = {
  app: { minHeight: "100vh", background: "linear-gradient(180deg,#072339,#041826)", padding: 24, color: "#fff", fontFamily: "Inter, system-ui, sans-serif" },
  ...
  greenBtn: { background: "#1ecf5b", border: 0, padding: "10px 14px", borderRadius: 20, cursor: "pointer" },
  blueBtn: { background: "#21b8ff", border: 0, padding: "10px 14px", borderRadius: 20, cursor: "pointer" },
  redBtn: { background: "#ff5b5b", border: 0, padding: "10px 14px", borderRadius: 20, cursor: "pointer" },
  orangeBtn: { background: "#f5a623", border: 0, padding: "10px 14px", borderRadius: 20, cursor: "pointer" },
  grayBtn: { background: "#666", border: 0, padding: "8px 12px", borderRadius: 8, cursor: "pointer", color: "#fff" },
  teamGrid: { display: "flex", flexWrap: "wrap", gap: 10 },
  teamBtn: { display: "flex", alignItems: "center", padding: 10, minWidth: 110, borderRadius: 8, background: "#07202b", color: "#fff", cursor: "pointer" },
  playersList: { marginTop: 8, display: "flex", flexDirection: "column", gap: 8, maxHeight: 220, overflowY: "auto" },
